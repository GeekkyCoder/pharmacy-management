import{V as le,U as ce,ae as pe,W as xe,b as h,O as e,am as O,a9 as L,ao as w,Z as z,a3 as C,aw as ge}from"./index-CZBkQvc6.js";import{M as he,T as V}from"./index-CB7-8BAQ.js";import{R as fe}from"./DownloadOutlined-Cittf3Xf.js";import"./ActionButton-BekEfBYN.js";import"./context-DaWUL4kl.js";const{Title:me}=ce,{Search:ye}=pe,ue=y=>{var $,k,R,D,N,K,W,Y,Q,E,B;const[q,H]=h.useState([]),[S,U]=h.useState({current:1,pageSize:10,total:0}),[G,F]=h.useState(!1),[T,Z]=h.useState(""),[J,P]=h.useState(!1),[r,_]=h.useState(null),[a,X]=h.useState(null),[ee,M]=h.useState(!1),A=async(t=1,i=10,n="")=>{var d,l;F(!0);try{const x=await C.get("/invoice/getAllInvoices",{params:{page:t,limit:i,search:n}}),{data:c,total:f,page:u,limit:v}=x.data;H(c==null?void 0:c.invoices),U({current:u,pageSize:v,total:f})}catch(x){y.error(((l=(d=x==null?void 0:x.response)==null?void 0:d.data)==null?void 0:l.message)||"Failed to fetch invoices")}finally{F(!1)}},te=async()=>{var t,i;try{const n=await C.get("/pharmacy-info");n.data.success&&X(n.data.data)}catch(n){y.error(((i=(t=n==null?void 0:n.response)==null?void 0:t.data)==null?void 0:i.message)||"Failed to fetch pharmacy information")}};h.useEffect(()=>{A(S.current,S.pageSize,T),te()},[]);const ie=t=>{A(t.current,t.pageSize,T)},ne=t=>{Z(t),A(1,S.pageSize,t)};console.log("Pharmacy Info:",a);const se=t=>{var n,d,l,x,c,f,u,v,b,I,s,p;if(!a){y.error("Pharmacy information is not available");return}const i=a;return`
      <html>
        <head>
